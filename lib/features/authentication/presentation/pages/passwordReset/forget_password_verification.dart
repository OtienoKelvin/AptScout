...
import 'package:apartment_scout/features/authentication/presentation/pages/passwordReset/password_reset.dart';
          ...
          child: Column(
            children: [
              ...
              SizedBox(
                ...
                child: ElevatedButton(onPressed: () => Get.to(() => const PasswordResetScreen()), child: const Text(STextStrings.verify),)
              ),
            ],
          ),
        )
